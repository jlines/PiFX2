...
function PixelBuffer(num_pixels){
    this.buffer = new Buffer(num_pixels * 3 + 4) // Internal buffer, each pixel is a group of three values
    this.readBuffer = new Buffer(num_pixels * 3 + 4)
...
PixelBuffer.prototype.setRGB = function(i, r, g, b){
    ...
    this.buffer[i * 3] = this.gamma[r];
    this.buffer[i * 3 + 1] = this.gamma[g];
    this.buffer[i * 3 + 2] = this.gamma[b];
}
